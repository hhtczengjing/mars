...
try:
    OHOS_SDK_ROOT = os.environ['OHOS_SDK']
...
OHOS_BUILD_CMD = 'cmake %s -DOHOS_ARCH="%s" ' \
                    '-DOHOS_PLATFORM=OHOS -DCMAKE_TOOLCHAIN_FILE=%s/native/build/cmake/ohos.toolchain.cmake ' \
                    '-DOHOS_STL="c++_shared" ' \
                    '&& cmake --build . '
OHOS_SYMBOL_PATH = 'libraries/mars_ohos_sdk/obj/local/'
OHOS_LIBS_PATH = 'libraries/mars_ohos_sdk/libs/'
OHOS_XLOG_SYMBOL_PATH = 'libraries/mars_ohos_xlog_sdk/obj/local/'
OHOS_XLOG_LIBS_PATH = 'libraries/mars_ohos_xlog_sdk/libs/'


OHOS_STL_FILE = {
        'armeabi-v7a': OHOS_SDK_ROOT + '/native/llvm/lib/arm-linux-ohos/libc++_shared.so',
        'arm64-v8a': OHOS_SDK_ROOT + '/native/llvm/lib/aarch64-linux-ohos/libc++_shared.so',
        'x86_64': OHOS_SDK_ROOT + '/native/llvm/lib/x86_64-linux-ohos/libc++_shared.so',
}
